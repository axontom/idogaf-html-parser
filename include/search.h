...
public:
    ...
    */
    static Vector_E Find(Element root, std::string query);
    /** Find elements in a tree
    ...
    */
    static Vector_P FindPtr(Element* root, std::string query);
    ...
    */
    static Vector_E FindInVector(Vector_E vec, std::string query);

protected:

private:
    /** Run single query */
    static Set_P RunQuery(Set_P elements, std::string query);
    ...
    */
    static Set_P CheckElements(Set_P elements, std::string query);
    /** Process separator
